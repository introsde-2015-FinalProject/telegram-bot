...
Our bot  is implemented using Ruby and with the help of the library telegram-bot-ruby. The bot uses HTTPS request to communicate with Telegram and the API of Business Logic Service and Process Centric Service to interact with our system.
